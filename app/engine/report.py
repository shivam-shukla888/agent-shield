...
class SecurityReportPDF(FPDF):
    """Custom FPDF layout for AgentShield security reports."""

    def header(self):
        self.set_font("Helvetica", "B", 14)
        self.set_text_color(30, 41, 59)
        self.cell(0, 10, "AgentShield Security Report", border=False, new_x="LMARGIN", new_y="NEXT", align="L")
...
class ReportEngine:
    ...
    def create_report(
        ...
        metadata = {
            "engine": "AgentShield Reporting Engine v1.0",
            "deterministic": True,
        }
...
<head>
    ...
    <title>AgentShield Security Report - {esc_target}</title>
    <style>
        :root {{
            --bg-color: #0f172a;
            --card-bg: #1e293b;
...
<body>
    <div class="container">
        ...
        <footer>
            <p>Generated by AgentShield Security Testing & Risk Analysis Platform</p>
        </footer>
    </div>
</body>
</html>"""
